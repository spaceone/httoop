...
@pytest.mark.parametrize('url,expected', (
	...
	pytest.param('ldap://[2001:db8::7]/c=GB?objectClass?one', (u'ldap', u'', u'', u'[2001:db8::7]', 389, u'/c=GB', u'objectClass?one', u''), marks=pytest.mark.skipif(True, reason='Parse query in ldap URI?')),
