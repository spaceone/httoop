...
from httoop.status import OK, CREATED, INTERNAL_SERVER_ERROR, NOT_MODIFIED, MULTIPLE_CHOICES, MOVED_PERMANENTLY, UNAUTHORIZED, NOT_FOUND, METHOD_NOT_ALLOWED, REQUEST_TIMEOUT, UPGRADE_REQUIRED
